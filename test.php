...
<body>
  ...
  <div class="row">
    <div class="col-sm-12">
      <img class="img-responsive" src="images/banners/ca6.png" alt="" width="100%" height="400" />
      <br>
    </div>
  </div>
  ...
  <form class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="fsremail" name="fsremail" value=<?php echo $fsremail; ?> placeholder=<?php echo $fsremail; ?> disabled>
      </div>
    </div>
    <div class="form-group">
