...
<div class="col-sm-7">
    <div class="col-sm-12">
      <div class="input-group">
        <input type="text" id="searchagent" class="form-control" placeholder="Search Agent by username or email" onkeypress="key_down_agent(event)">
