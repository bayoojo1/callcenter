...
$sql = "SELECT users.email, businessdetails.fsrUsername FROM subscription INNER JOIN users ON subscription.username=users.username INNER JOIN businessdetails ON subscription.username=businessdetails.username WHERE subscription.end_date = CURDATE() - INTERVAL 2 DAY";
...
<title>CallNect Message</title>
  ...
  <body style="margin:0px; font-family:Tahoma, Geneva, sans-serif;">
    ...
    <br />
    <br />
    Your current subscription would be expiring tomorrow.
    <br />
