...
<div class="col-sm-7">
  <nav class="navbar navbar-default">
    <div id="fsrlistdiv">My Business List <span class="badge" id="fsrbadge"></span></div>
  </nav>
  <?php include_once("functions/fsr_business_display.php"); ?>
</div>
